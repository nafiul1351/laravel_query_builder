    ...
    <div class="main">
        ...
        <form class="main_form" method="post" action="{{ route('add') }}" enctype="multipart/form-data">
            ...
            <div class="form_section">
                ...
                <input class="input_section @error('text') is-invalid @enderror" id="text" type="text" name="text" required>
                @error('text')
            ...
            <div class="form_section">
                ...
                <input class="input_section @error('number') is-invalid @enderror" id="number" type="number" name="number" required>
                @error('number')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
